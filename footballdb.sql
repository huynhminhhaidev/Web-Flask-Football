...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 21, 2022 lúc 08:10 AM
...
CREATE TABLE `address` (
  ...
  `linkAddress` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `iframe` varchar(500) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `phone1` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `phone2` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `service` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `note` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL
...
INSERT INTO `address` (`id`, `idHost`, `name`, `address`, `city`, `district`, `linkAddress`, `iframe`, `phone1`, `phone2`, `service`, `note`) VALUES
(1, 4, 'Sân Bóng Đá Mini Hải Yến', 'Unnamed Road, Bến Lức, Long An, Việt Nam', 'Tỉnh Long An', 'Huyện Bến Lức', 'https://goo.gl/maps/ZX9pk5RH6fMWftoq5', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3921.333414033001!2d106.49302031529285!3d10.631185264763616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310acd6e4923452d%3A0x2586abca042c9369!2sS%C3%A2n%20banh%20CR7!5e0!3m2!1svi!2s!4v1654055681057!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', '0848551555', '0909372444', 'Căn tin, gửi xe, shop phụ kiện bóng đá.', 'Đi sớm 15p để chuẩn bị nhận sân.'),
(2, 4, 'Sân banh CR7', 'Hoàng Long, KP9, Bến Lức, Long An, Việt Nam', 'Tỉnh Long An', 'Huyện Bến Lức', 'https://goo.gl/maps/3Pj6MvpvmpWsqrZo7', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3921.3904908074505!2d106.48906901529266!3d10.626741464843336!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310acd30e01655b7%3A0xa211e1c455cd79c!2zU8OibiBCw7NuZyDEkMOhIE1pbmkgSOG6o2kgWeG6v24!5e0!3m2!1svi!2s!4v1654055707097!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', '0848551555', '0909372444', 'Gửi xe, căn tin.', 'Đi sớm 15p.'),
(3, 6, 'Sân Bóng Đá Mini Long Kim', '124 Đ. Phan Văn Mảng, TT. Bến Lức, Bến Lức, Long An, Việt Nam', 'Tỉnh Long An', 'Huyện Bến Lức', 'https://goo.gl/maps/4qbSzhhQpXi9EpyZ9', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3921.32922463103!2d106.49050531529274!3d10.631511364757731!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x310acc814dabbe51%3A0x183aeab49fd93a03!2zU8OibiBCw7NuZyDEkMOhIE1pbmkgTG9uZyBLaW0!5e0!3m2!1svi!2s!4v1654746028351!5m2!1svi!2s\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>', '0908372432', '', 'Gửi xe, căn tin', '');
...
CREATE TABLE `bill` (
  ...
  `cost` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
INSERT INTO `bill` (`id`, `idMember`, `idMatch`, `cost`) VALUES
(1, 3, 6, '200.000'),
(2, 3, 7, '300.000'),
(3, 7, 8, '350.000'),
(6, 3, 9, '350.000');
...
CREATE TABLE `district` (
  ...
  `name` varchar(100) CHARACTER SET utf8 NOT NULL,
  `type` varchar(30) CHARACTER SET utf8 NOT NULL,
  `idCity` varchar(5) CHARACTER SET utf8 NOT NULL
...
INSERT INTO `district` (`id`, `name`, `type`, `idCity`) VALUES
...
CREATE TABLE `matchh` (
  ...
  `phonebackup` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `note` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `datetimePay` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `statusPay` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;

--
-- Đang đổ dữ liệu cho bảng `matchh`
--

INSERT INTO `matchh` (`id`, `idTime`, `idMember`, `idPitch`, `idAddress`, `date`, `phonebackup`, `note`, `status`, `datetimePay`, `statusPay`) VALUES
(3, 13, 3, 4, 2, '05-06-2022', '', '', 'Không thanh toán', '04-06-2022 02:38', 'False'),
(4, 6, 3, 2, 2, '05-06-2022', '', '', 'Không thanh toán', '04-06-2022 02:43', 'False'),
(5, 21, 3, 6, 1, '05-06-2022', '', '', 'Từ chối', '', 'False'),
(6, 13, 3, 4, 2, '08-06-2022', '', '', 'Đã thanh toán', '06-06-2022 16:21', 'False'),
(7, 2, 3, 1, 2, '09-06-2022', '', '', 'Đã thanh toán', '06-06-2022 16:23', 'False'),
(8, 18, 7, 5, 1, '07-06-2022', '', '', 'Đã thanh toán', '07-06-2022 01:44', 'False'),
(9, 15, 3, 4, 2, '10-06-2022', '', '', 'Đã thanh toán', '09-06-2022 16:44', 'False'),
(18, 14, 3, 4, 2, '10-06-2022', '', '', 'Không thanh toán', '09-06-2022 17:35', 'False'),
(19, 15, 7, 4, 2, '12-06-2022', '', '', 'Không thanh toán', '11-06-2022 15:46', 'False'),
(20, 15, 7, 4, 2, '12-06-2022', '', '', 'Không thanh toán', '12-06-2022 01:10', 'False'),
(21, 24, 7, 7, 3, '17-06-2022', '', '', 'Từ chối', '', 'False'),
(22, 5, 3, 2, 2, '20-06-2022', '', '', 'Không thanh toán', '18-06-2022 18:51', 'False');
...
CREATE TABLE `pitch` (
  ...
  `idHost` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `kind` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
INSERT INTO `pitch` (`id`, `idAddress`, `idHost`, `name`, `kind`) VALUES
(1, 2, 4, 'Sân 1', '5'),
(2, 2, 4, 'Sân 2', '5'),
(3, 2, 4, 'Sân 3', '5'),
(4, 2, 4, 'Sân 4', '7'),
...
CREATE TABLE `time` (
  `id` int(11) NOT NULL,
  `idPitch` int(11) NOT NULL,
  `timeS` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `timeE` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  `cost` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
INSERT INTO `time` (`id`, `idPitch`, `timeS`, `timeE`, `cost`) VALUES
(1, 1, '16:00', '17:30', '200.000'),
(2, 1, '17:30', '19:00', '290.000'),
(3, 1, '19:00', '20:30', '350.000'),
(4, 1, '20:30', '22:00', '400.000'),
(5, 2, '16:00', '17:30', '200.000'),
(6, 2, '17:30', '19:00', '290.000'),
(7, 2, '19:00', '20:30', '350.000'),
(8, 2, '20:30', '22:00', '400.000'),
(9, 3, '16:00', '17:30', '200.000'),
(10, 3, '17:30', '19:00', '290.000'),
(11, 3, '19:00', '20:30', '350.000'),
(12, 3, '20:30', '22:00', '400.000'),
(13, 4, '16:00', '17:30', '400.000'),
(14, 4, '17:30', '19:00', '580.000'),
(15, 4, '19:00', '20:30', '700.000'),
(16, 4, '20:30', '22:00', '700.000'),
(17, 5, '16:00', '17:30', '210.000'),
(18, 5, '17:30', '19:00', '300.000'),
(19, 5, '19:00', '20:30', '360.000'),
(20, 5, '20:30', '22:00', '360.000'),
(21, 6, '17:30', '19:00', '310.000'),
(22, 6, '19:00', '20:30', '360.000'),
(23, 6, '20:30', '22:00', '360.000'),
(24, 7, '16:00', '17:30', '200.000'),
(26, 7, '17:30', '19:00', '280.000'),
(27, 7, '19:00', '20:30', '330.000'),
(28, 7, '20:30', '22:00', '400.000');
...
CREATE TABLE `user` (
  ...
  `birthday` varchar(255) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
INSERT INTO `user` (`id`, `fullname`, `gender`, `birthday`, `phonenumber`, `email`, `role`, `password`, `linkFB`) VALUES
(2, 'admin', 'male', '', '', 'admin@gmail.com', 'Admin', 'sha256$EpC7jbd8osOhtpqq$48567e98615e3b135badb572bfd7b75bb005dfe6c079882b64e99498ddafd4b0', ''),
(3, 'Nguyễn Văn B', 'male', '08/06/2000', '0909372444', 'hmh551555@gmail.com', 'ThanhVien', 'sha256$UUR4YikWJgaXReKe$7b9edfd15e02fc1e48600190a76d7381312214ac53c68df4f14e6df2bf5b0084', ''),
(4, 'Huỳnh Minh Hải', 'male', '12/12/2000', '0848551555', 'huynhminhhai1555@gmail.com', 'ChuSan', 'sha256$L4DRBQoBkRAk8YEI$e401347cc1a8dc0180fc44c69a0c643f70b6bc1bed5328d19adb7a05c4912133', 'https://www.facebook.com/profile.php?id=100009242465459'),
(6, 'Nguyễn Văn C', 'male', '12/11/2000', '0909372444', 'hmh1555@gmail.com', 'ChuSan', 'sha256$Ey5COzVGkc3HSKrI$d28576ec6cdfa44524cdee8f6b6b593d1f0b503ced572257a0814a17970820fd', ''),
(7, 'Nguyễn Văn A', 'male', '08/06/2000', '0848551444', 'huynhminhhai1555555@gmail.com', 'ThanhVien', 'sha256$oF5PE5FBpKrFRott$2b1ffb5c623a6b9835e6c18d24ccbffca39011cb39f84dcead109a0df60af015', '');
...
--
-- AUTO_INCREMENT cho bảng `matchh`
--
ALTER TABLE `matchh`
